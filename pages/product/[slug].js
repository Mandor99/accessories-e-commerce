...
function Product({product: {image, details, smallDetails, rate, numRates, price, slug}, products}) {
                ...
                <div className="container">
                    <div className="content flex gap-8 flex-col md:flex-row">
                        <div className="product-img">
                            <figure className='relative w-full lg:w-[25vw] h-[250px] shadow-md md:w-[40vw] md:h-[325px] md:shadow-none lg:h-[300px] rounded-3xl bg-my-light-100 flex items-center justify-center cursor-pointer hover:bg-my-red transition-colors'>
                        ...
                        <article className="product-details">
                            ...
                            <h3 className="text-my-red-100 my-5 md:my-3 lg:my-5 font-bold text-2xl md:text-xl lg:text-2xl">{price}$</h3>
